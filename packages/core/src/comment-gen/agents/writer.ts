import type { CommentAgentConfig } from "../def.js";

export const analytical: CommentAgentConfig = {
  name: "analytical",
  instructions:
...
export const descriptive: CommentAgentConfig = {
  name: "descriptive",
  instructions:
...
export const emotional: CommentAgentConfig = {
  name: "emotional",
  instructions:
...
export const humorous: CommentAgentConfig = {
  name: "humorous",
  instructions:
...
export const predictive: CommentAgentConfig = {
  name: "predictive",
  instructions:
...
export const summary: CommentAgentConfig = {
  name: "summary",
  instructions:
